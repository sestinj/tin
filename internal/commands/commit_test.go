...
func TestCommit_ChainedCommits(t *testing.T) {
	...
	repo.StageThread(thread1.ID, len(thread1.Messages), thread1.ComputeContentHash())
	...
	repo.StageThread(thread2.ID, len(thread2.Messages), thread2.ComputeContentHash())
